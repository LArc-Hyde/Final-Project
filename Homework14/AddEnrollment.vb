Public Class AddEnrollment
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        If hits.Count > 0 Then
            ...
            Next
        Else
            For iter2 As Integer = 0 To main.enroll.getStudentCount - 1
                lstNotEnrolled.Items.Add(main.enroll.Students(iter2).FirstName & " " &
                        main.enroll.Students(iter2).LastName & " " &
                        main.enroll.Students(iter2).StudentNumber)
            Next
        End If
    End Sub
End Class